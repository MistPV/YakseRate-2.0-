  ...
  <main>
               ...
               <form class="pl-40 ml-80">   
                ...
                <div class="relative">
                  <form action='rate.php' method='post'>
                    <input type="text" name='search_text' class="block p-1 pl-5 w-80 text-sm text-white bg-[#5A72A6] rounded-lg placeholder-[#2A488D] placeholder-opacity-75" placeholder="Ф.И.О студента" required>
      ...
      <div class="container mx-[25rem] w-max relative overflow-x-auto sm:rounded-3xl mt-5">
        <table class="text-sm text-left text-white">
              ...
              {
                 $query="SELECT * FROM `users` WHERE full name LIKE '%$search_text%'";
              }
            ...
            <thead class="text-xs text-white bg-[#5A72A6] rounded-lg">
                <tr>
                    ...
                    <th scope="col" class="px-8 py-3">
                        <img class="rounded-full h-20 w-20" src="img/<?echo $row[4];?>">
                    </th>
                    <th scope="col" class="px-8 text-2xl py-3">
                        <? echo $row[1];?>
                    </th>
                    <th scope="col" class="text-2xl px-8 py-3 uppercase">
                        <? echo $row[5];?>
                        <p class="px-8 text-xs text-[#2A488D]">группа</p>
                    </th>
                    <th scope="col" class="text-2xl px-12 py-3">
                        <? echo $row[6];?>
